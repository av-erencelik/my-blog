...
export const RichTextComponents = {
  ...
  block: {
    ...
    blockquote: ({ children }: any) => (
      <blockquote className="border-l-cyan-300 border-l-4 pl-5 py-5 my-5">{children}</blockquote>
    ),
  },
  marks: {
    link: ({ children, value }: any) => {
      ...
      return;
      <Link href={value.href} rel={rel} className="underline decoration-cyan-300 hover:decoration-black">
        {children}
      </Link>;
    },
  },
